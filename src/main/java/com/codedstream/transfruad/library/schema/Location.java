...
public class Location extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.codedstream.transfruad.library.schema.Location.Builder newBuilder() {
    return new com.codedstream.transfruad.library.schema.Location.Builder();
  }
   ...
   * @return A new Location RecordBuilder
   */
  public static com.codedstream.transfruad.library.schema.Location.Builder newBuilder(com.codedstream.transfruad.library.schema.Location.Builder other) {
    if (other == null) {
      return new com.codedstream.transfruad.library.schema.Location.Builder();
    } else {
      return new com.codedstream.transfruad.library.schema.Location.Builder(other);
    }
  }
   ...
   * @return A new Location RecordBuilder
   */
  public static com.codedstream.transfruad.library.schema.Location.Builder newBuilder(com.codedstream.transfruad.library.schema.Location other) {
    if (other == null) {
      return new com.codedstream.transfruad.library.schema.Location.Builder();
    } else {
      return new com.codedstream.transfruad.library.schema.Location.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Location>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.codedstream.transfruad.library.schema.Location.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.codedstream.transfruad.library.schema.Location other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.latitude)) {
        this.latitude = data().deepCopy(fields()[0].schema(), other.latitude);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codedstream.transfruad.library.schema.Location.Builder setLatitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codedstream.transfruad.library.schema.Location.Builder clearLatitude() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codedstream.transfruad.library.schema.Location.Builder setLongitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codedstream.transfruad.library.schema.Location.Builder clearLongitude() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codedstream.transfruad.library.schema.Location.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codedstream.transfruad.library.schema.Location.Builder clearCountry() {
      country = null;
